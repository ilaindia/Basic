<%@ Page Title="" Language="C#" MasterPageFile="~/scl_master.Master" AutoEventWireup="true" CodeBehind="general.aspx.cs" Inherits="School.general" EnableEventValidation="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="navication" runat="server">
    ...
    <li>
        <a href="gvunit.aspx"><span class="fa fa-users"></span><span class="xn-text">Family Details</span></a>
    </li>
</asp:Content>
...
<asp:Content ID="Content7" ContentPlaceHolderID="panel_controlls" runat="server">
    ...
    <asp:Panel ID="pn_enterybtn" runat="server">
        <ul class="panel-controls">
            ...
            <li>
                <asp:Button ID="btn_sve" runat="server" Text="save" CssClass="btn btn-sm btn-primary" ValidationGroup="FormValidation" OnClick="btn_sve_Click" /></li>
            <li>
...
<asp:Content ID="Content5" ContentPlaceHolderID="content" runat="server">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <asp:RequiredFieldValidator ID="jd" ValidationGroup="FormValidation" runat="server"
                        ErrorMessage="Please Enter Full Name" ControlToValidate="fn" CssClass="alert-danger">
    ...
    <asp:Panel ID="pnl_gv" runat="server">
        <asp:GridView ID="gv_cust" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false" AllowSorting="true" EmptyDataText="No Record Found !" ShowHeaderWhenEmpty="true">
            <Columns>
...
<asp:Content ID="Content6" ContentPlaceHolderID="panel_footer" runat="server">
</asp:Content>
