$(function() {
    if($('body').data('page') == 'login'){
        ...
        $.backstretch(["content/images/gallery/login.jpg"],
        {
            fade: 600,
            duration: 4000
        });
        ...
        $('#slide-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["content/images/gallery/login4.jpg", "content/images/gallery/login3.jpg", "content/images/gallery/login2.jpg", "content/images/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
