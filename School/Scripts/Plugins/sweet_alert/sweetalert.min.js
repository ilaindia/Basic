...
;(function(window, document, undefined) {
  ...
  function setParameters(params) {
    ...
    // Title
    $title.innerHTML = params.title;(params.html) ? params.title : escapeHtml(params.title).split("\n").join("<br>");

    // Text
    $text.innerHTML = params.text;//(params.html) ? params.text : escapeHtml(params.text || '').split("\n").join("<br>");
