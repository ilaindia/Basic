...
namespace GuruBal
{
	public class BLL_Master_Table : GuruSqlBridge
    {
        #region Varialble or Object Initial like TableName/AuditTableName/KeyfieldName/Object & Varialbe Declaration
        /// <summary>
        /// <see cref="BLL_Master_Table" /> Belongs to MASTER_TABLE
        /// </summary>
        public string tablename { get { return "MASTER_TABLE"; } }
        /// <summary>
        /// Primary_Key For Master_Table is SYS_ID
        /// </summary>
        public string keyfield = "SYS_ID";


        /// <summary>
        /// Initializes a new instance of the <see cref="BLL_Master_Table" /> class with parameter connection string
        /// </summary>
        /// <param name="connectionstring">connection string</param>
        public BLL_Master_Table(SqlConnection Connection, string Actionby, string CompanyId)
            : base(Connection, Actionby, CompanyId)
        {
            this.Data = new TblMaster_Table();
            this.Pager = new sqlPager();
        }
        /// <summary>
        /// Initializes a new instance of the <see cref="BLL_Master_Table" /> 
        /// </summary>
        public BLL_Master_Table(string Connection, string Actionby, string CompanyId)
            : base(Connection, Actionby, CompanyId)
        {
            this.Data = new TblMaster_Table();
            this.Pager = new sqlPager();
        ...
        /// <summary>
        /// Gets or sets the data for Master_Table
        /// </summary>
        public TblMaster_Table Data { get; set; }
        /// <summary>
