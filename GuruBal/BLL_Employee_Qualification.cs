...
namespace GuruBal
{
	public class BLL_Employee_Qualification : GuruSqlBridge
    {
        #region Varialble or Object Initial like TableName/AuditTableName/KeyfieldName/Object & Varialbe Declaration
        /// <summary>
        /// <see cref="BLL_Employee_Qualification" /> Belongs to EMPLOYEE_QUALIFICATION
        /// </summary>
        public string tablename { get { return "EMPLOYEE_QUALIFICATION"; } }
        /// <summary>
        /// Primary_Key For Employee_Qualification is SYS_ID
        /// </summary>
        public string keyfield = "SYS_ID";


        /// <summary>
        /// Initializes a new instance of the <see cref="BLL_Employee_Qualification" /> class with parameter connection string
        /// </summary>
        /// <param name="connectionstring">connection string</param>
        public BLL_Employee_Qualification(SqlConnection Connection, string Actionby, string CompanyId)
            : base(Connection, Actionby, CompanyId)
        {
            this.Data = new TblEmployee_Qualification();
            this.Pager = new sqlPager();
        }
        /// <summary>
        /// Initializes a new instance of the <see cref="BLL_Employee_Qualification" /> 
        /// </summary>
        public BLL_Employee_Qualification(string Connection, string Actionby, string CompanyId)
            : base(Connection, Actionby, CompanyId)
        {
            this.Data = new TblEmployee_Qualification();
            this.Pager = new sqlPager();
        ...
        /// <summary>
        /// Gets or sets the data for Employee_Qualification
        /// </summary>
        public TblEmployee_Qualification Data { get; set; }
        /// <summary>
        ...
        /// </summary>
        public class TblEmployee_Qualification
        {
            public string SYS_ID { get; set; }
			public string QUALIFICATION { get; set; }
			public string SUBJECT { get; set; }
			public string DEGREE { get; set; }
			public string INSTUT { get; set; }
        ...
        public override string InsertUpdateEntry()
        {
            try
            {
				...
				this.AddColumnParameter("SUBJECT", this.Data.SUBJECT);
				this.AddColumnParameter("DEGREE", this.Data.DEGREE);
				this.AddColumnParameter("INSTUT", this.Data.INSTUT);
				this.AddColumnParameter("MEDIUM", this.Data.MEDIUM);
				this.AddColumnParameter("PASS_YEAR", this.Data.PASS_YEAR);
				this.AddColumnParameter("PERCENTAGE", this.Data.PERCENTAGE);
        ...
        public override void GetDataEntry(string keyID)
        {
            ...
            if (dt.Rows.Count > 0)
            {
				...
				Data.SUBJECT = GuruConvert.AsString(dt.Rows[0]["SUBJECT"]);
				Data.DEGREE = GuruConvert.AsString(dt.Rows[0]["DEGREE"]);
				Data.INSTUT = GuruConvert.AsString(dt.Rows[0]["INSTUT"]);
				Data.MEDIUM = GuruConvert.AsString(dt.Rows[0]["MEDIUM"]);
				Data.PASS_YEAR = GuruConvert.AsString(dt.Rows[0]["PASS_YEAR"]);
				Data.PERCENTAGE = GuruConvert.AsString(dt.Rows[0]["PERCENTAGE"]);
